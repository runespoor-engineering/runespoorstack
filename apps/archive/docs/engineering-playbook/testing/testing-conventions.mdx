...
- Follow the [Integration Testing Coverage](/docs/engineering-playbook/testing/integration-testing-coverage).
...
- Use `mixins/jest` or `mixins/vitest` from [@runespoor/eslint-config](https://github.com/runespoor-engineering/runespoorstack/tree/main/eslint/eslint-config).
