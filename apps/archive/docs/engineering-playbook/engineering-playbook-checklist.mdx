...
- ✅ For public repositories, the default branch should contain the following files: Description, [README,](https://github.com/BorysShulyak/runespoor-engineering/runespoorstack/blob/main/README.md) [Code of conduct,](https://github.com/BorysShulyak/runespoor-engineering/runespoorstack/blob/main/CODE_OF_CONDUCT.md) [Contributing,](https://github.com/BorysShulyak/runespoor-engineering/runespoorstack/blob/main/CONTRIBUTING.md) [License,](https://github.com/BorysShulyak/runespoor-engineering/runespoorstacka/blob/main/LICENSE) [Security policy](https://github.com/BorysShulyak/runespoor-engineering/runespoorstack/blob/main/SECURITY.md), [Issue templates](https://github.com/BorysShulyak/runespoor-engineering/runespoorstack/tree/main/.github/ISSUE_TEMPLATE), [Pull request template](https://github.com/BorysShulyak/runespoor-engineering/runespoorstack/blob/main/.github/PULL_REQUEST_TEMPLATE.md)
...
- ✅ All the builds and deploys are automated and automated.
