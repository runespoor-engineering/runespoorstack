...
Here you can see the list of labels I recommend using in your project.

## Why do you need configured project labels in your GitHub / GitLab repository?
...
- `"workflow::revoked"`: Add this label to the PR/Issue if you have some comments on the PR/Issue and are requesting answers or changes.

### Specialization Labels

These labels narrow the specialization of a unit of work.
